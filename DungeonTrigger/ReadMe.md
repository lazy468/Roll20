...
<p>This is useful for automatically opening dynamic lighting areas to players or marking the trigger with a <img src='https://game-icons.net/icons/ffffff/000000/1x1/lorc/padlock.png' alt='Padlock' width='20' height='20' /> padlock icon puts the trigger into manual mode allowing players to activate it themselves with the <code>!dt --activate</code> command. I like to make an "Action" macro for my players with the command in it.</p>
Here are some examples:<br />  
